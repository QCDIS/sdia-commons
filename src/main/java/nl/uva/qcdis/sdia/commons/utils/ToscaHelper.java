...
import nl.uva.qcdis.sdia.sure.tosca.client.DefaultApi;
import org.apache.commons.io.FileUtils;
import nl.uva.qcdis.sdia.sure.tosca.client.ApiException;
import nl.uva.qcdis.sdia.sure.tosca.client.Configuration;
import org.springframework.beans.factory.annotation.Autowired;
import static nl.uva.qcdis.sdia.commons.utils.Constants.*;
import nl.uva.qcdis.sdia.model.cloud.storm.CloudsStormSubTopology.StatusEnum;
...
public class ToscaHelper {
    ...
    public List<Credential> getCredentialsFromVMTopology(NodeTemplateMap vmTopologyMap) throws Exception {
        ...
        if (vmTopology.getType().equals(VM_TOPOLOGY)) {
            ...
            if (att.containsKey("credentials")){
            ...
            }else if (att.containsKey("credential")){
                Map<String, Object> mapCredential =  (Map<String, Object>) att.get("credential");    
